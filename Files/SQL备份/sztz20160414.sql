...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-04-14 03:12:15
-- 服务器版本： 5.7.9
-- PHP Version: 5.6.16
...
(3, 1, '超级管理员', 0, 'H', '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `t_profession` (
  ...
  `name` varchar(32) NOT NULL COMMENT '名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='专业表';
...
CREATE TABLE IF NOT EXISTS `t_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='素质拓展记录表';
...
CREATE TABLE IF NOT EXISTS `t_student_teacher` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='学生老师关系表';
...
CREATE TABLE IF NOT EXISTS `t_type` (
  ...
  `name` varchar(32) NOT NULL COMMENT '名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='素质拓展类型表';
...
DROP TABLE IF EXISTS `t_type_grade_profession`;
CREATE TABLE IF NOT EXISTS `t_type_grade_profession` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='拓展类型&专业&年级表';
...
DROP TABLE IF EXISTS `t_user_control`;
CREATE TABLE IF NOT EXISTS `t_user_control` (
  ...
  `created_at` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8 COMMENT='用户操作记录表';
...
CREATE TABLE IF NOT EXISTS `t_user_message` (
  ...
  `created_at` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='用户消息表';
